<template>
    ...
    <Transition name="fade">
        <TodoMyChangeName v-if="showChangeNameModal" @close="showChangeNameModal = false" />
    </Transition>
    <Transition name="fade">
...
import TodoMyChangeName from '@/components/MyChangeName.vue';
import TodoMyChangeDescription from '@/components/MyChangeDescription.vue';
